                    ...
                    <div class="panel-body" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                            <div class="form-group col-lg-8 col-md-8 col-sm-8 col-xs-12">
                              ...
                              <select id="idproveedor" name="idproveedor" class="form-control" data-live-search="true" required>
                            ...
                            <div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12">
                              <a data-toggle="modal" href="#myModal">
                                <button id="btnAgregarArt" type="button" class="btn btn-primary"><i class="fa fa-plus" aria-hidden="true"></i> Agregar Articulos</button>
                              </a>
                            </div>
                            ...
                            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                              ...
                              <button class="btn btn-primary" type="submit" id="btnGuardar">
                               ...
                               <button  id="btnCancelar" class="btn btn-danger" onclick="cancelarform()" type="button" id="btnCacelar">
